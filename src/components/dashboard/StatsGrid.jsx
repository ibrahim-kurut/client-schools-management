...
export default function StatsGrid() {
  const stats = [
    { label: "إجمالي الطلاب", value: "1,250", icon: Users, color: "from-blue-500 to-indigo-600", bgLight: "bg-blue-50", text: "text-blue-600" },
    { label: "أعضاء كادر تدريسي", value: "84", icon: GraduationCap, color: "from-emerald-400 to-teal-500", bgLight: "bg-emerald-50", text: "text-emerald-600" },
    { label: "الصفوف الدراسية", value: "32", icon: Layers, color: "from-amber-400 to-orange-500", bgLight: "bg-amber-50", text: "text-amber-600" },
    { label: "الإيرادات الإجمالية", value: "12,400 $", icon: Wallet, color: "from-purple-500 to-pink-600", bgLight: "bg-purple-50", text: "text-purple-600" },
  ];
